...
if __name__ == '__main__':
    start = time()
    _INPUT_DIR = r'\\10.99.68.178\Saurabh\film_train_v2\sequences\trainingset_sk7_panc\test\sequences'
    _INTPUT_TRIPLET_LIST_FILEPATH = r'\\10.99.68.178\Saurabh\film_train_v2\sequences\trainingset_sk7_panc\test\sequences.txt'
    _OUTPUT_TFRECORD_FILEPATH = r'\\10.99.68.178\Saurabh\film_train_v2\sequences\trainingset_sk7_panc\test\sequences.tfrecord'
