...
if __name__ == '__main__':
    start = time()
    _INPUT_DIR = r'\\shelter\Kyu\motility_interpolation\filmtest_train_skip5\sequences'
    _INTPUT_TRIPLET_LIST_FILEPATH = r'\\shelter\Kyu\motility_interpolation\filmtest_train_skip5\sequences.txt'
    _OUTPUT_TFRECORD_FILEPATH = r'\\shelter\Kyu\motility_interpolation\filmtest_train_skip5\sequences.tfrecord'
